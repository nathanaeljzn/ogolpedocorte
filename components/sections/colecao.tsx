...
export function Colecao() {
  return (
    <section id="colecao" className="py-24 md:py-32 px-6 bg-zinc-100 border-y border-zinc-300/50">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-display font-bold tracking-tight mb-8 text-zinc-900">A Coleção</h2>
